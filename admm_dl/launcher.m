...
for i=1:length(vec)
    switch vec(i)
        case 1
            learning.lambdasparsecodevec=[0.05 0.1 0.2 0.3]; % regularization parameters
            learning.lambdasparsecodevec=[0.05]
            learning.type='gaussian';
            comment='unit-norm';
            options.matapprox.leftregularizer='proj-unitnorm2';
            toyBench(comment,learning,options);
        case 2
            learning.lambdasparsecodevec=[0.05 0.1 0.2 0.3]; % regularization parameters
            learning.lambdasparsecodevec=[0.05]
