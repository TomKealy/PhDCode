function get_activeset_pi4_speed_comparison( p )
...
switch p
 ...
 additional_arguments.model = 'activeset'; 
...
[ prediction_error, estimation_error, hull_estimation_error, cpu_time, output_params ] = get_regpaths( height, width, hull_pattern, Lambda, n_tr, n_runs, additional_arguments );
 ...
 save([path_to_data 'activeset_pi4_speed_comparison_p_' int2str(p)],'prediction_error', 'estimation_error', 'hull_estimation_error', 'cpu_time', 'output_params');
