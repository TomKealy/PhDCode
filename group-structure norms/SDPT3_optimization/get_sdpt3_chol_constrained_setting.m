function [ At, b, c, blk ] = get_sdpt3_chol_constrained_setting( XtX_over_n, XtY_over_n, G, D, lambda )
...
% position 2:1+ng, variables that upperbound each block |d^G o w_G|_2
% position 2+ng:end, variables that correspond to the loadings w
...
%==========================================================================
% Block for the constraint sum_G |d_G o w_G|_2 < \lambda
...
At{2} = sparse( ones(ng,1), 2:ng+1, ones(ng,1), 1, n_variables, ng );
