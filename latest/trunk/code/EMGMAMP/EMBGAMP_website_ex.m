...
nmse = 10*log10(norm(x-xhat)^2/norm(x)^2) % Report EMBGturboAMP's NMSE (in dB)
...
nmse6 = 10*log10(norm(x-xhat)^2/norm(x)^2) % Report EMBGturboAMP's NMSE (in dB)
...
nmse7 = 10*log10(norm(x-xhat)^2/norm(x)^2) % Report EMBGturboAMP's NMSE (in dB)
